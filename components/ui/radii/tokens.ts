...
export const radii = {
  ...
  sm: { value: '12px', use: 'IconButton sm to lg, TextField, SegmentedControl segments, and the focus ring on plain elements' },
  md: { value: '16px', use: 'Button sm to lg, the SegmentedControl tray and OptionCard' },
  lg: { value: '20px', use: 'Card, and TextArea' },
  xl: { value: '24px', use: 'Card overlay: dialogs, menus and popovers' },
  full: { value: '999px', use: 'Anything round: Chip, avatars, radio dots and round buttons. On a square it is a circle, on a wide shape a pill.' },
