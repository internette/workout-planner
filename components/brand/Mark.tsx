...
export const MARK_FACETS = [
  { d: 'M24.9 9.1 L22.1 18.1 L10.8 20.7 Z', fill: '#E1699C' },
  { d: 'M10.8 20.7 L22.1 18.1 L23.3 27.5 L9.1 39 Z', fill: '#C173AF' },
  { d: 'M9.1 39 L23.3 27.5 L28.4 35.6 L20.7 53.2 Z', fill: '#A17EC2' },
