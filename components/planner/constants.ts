...
export const RANKS = [
  ...
  { name:'Eternal sovereign', next:'the next season', pill:'background:var(--gradient-gem);color:var(--color-on-accent);box-shadow:0 2px 8px color-mix(in srgb, var(--color-accent) 35%, transparent)', gem:'var(--color-white)' },
];
