...
export const RANKS = [
  ...
  { name:'Eternal sovereign', next:'the next season', pill:'background:var(--gradient-gem);color:var(--color-on-accent);box-shadow:0 2px 8px rgba(213,49,129,.35)', gem:'var(--color-white)' },
];
